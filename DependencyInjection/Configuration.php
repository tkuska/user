                    ...
                    ->children()
                        ...
                        ->arrayNode('form')
                            ...
                            ->children()
                                ...
                                ->scalarNode('template')->defaultValue('TkuskaUserBundle:Creation:create.html.twig')->end()
                    ...
                    ->children()
                        ->arrayNode('form')
                            ...
                            ->children()
                                ...
                                ->scalarNode('template')->defaultValue('TkuskaUserBundle:Edition:edit.html.twig')->end()
